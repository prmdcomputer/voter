 ...
 * This bypasses CORS restrictions that occur in the browser.
 */
export async function fetchVoterFromECI() {
  ...
  try {
    ...
    console.error('ECI API Fetch Error:', error);
    throw new Error(error.message || 'Failed to fetch from ECI Gateway');
  }
}
